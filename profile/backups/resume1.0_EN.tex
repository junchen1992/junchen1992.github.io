...
\begin{CJK*}{UTF8}{song}
 \moveleft.5\hoffset\centerline{ {\Large \bf Jun Chen} }
\end{CJK*}
...
%37 Chandler St.,
%BELCONNEN,
%ACT 2617 \hspace{20pt} tlnd.sky@gmail.com \hspace{20pt} +61-416354917}
%\end{CJK*}
...
%\begin{itemize}
%	\item{\bf Foodie.}
%	\item{\bf Intelligent Parking Management System.}
%	\item{\bf Vimi.}
%	\item{\bf Face Recognition Based on QR Code.}
%	\item{\bf Home Page of SSDUT.}
%	\item{\bf Online Shopping Website Design.}
%\end{itemize}
